...
@SpringBootTest
@Transactional
public class RegraNaoHaPagamentoEmFilaTest {

	@Autowired
	private EntityManager em;
	
	@Autowired
	private RegraNaoHaPagamentoEmFila regra;
	
	@Test
	public void deveSerVerdadeiroSeNaoExistePagamentoEmFila() {
		...
		estados.forEach(estado -> {
			Evento evento = new Evento()
					.setTipoEvento(TipoEvento.PAGAMENTOS)
					.setEstado(estado);
	...
	@Test
	public void deveSerFalsoSeExistePagamentoEmFilaOuProcessamento() {
		List<Estado> estados = Arrays.asList( 
				Estado.EM_FILA, 
